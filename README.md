# [DATE 2026] FORWORD: Accelerating Formal Datapath Verification via Word-Level Sweeping
...
For a quick example of how to use, you may look at **`apps/main_cec.cpp`**
